...
This repository provides the experimental implementation of **GHGR**, a  malicious VPN traffic detection framework based on hierarchical granularity representation. The codebase follows a two-stage workflow:
